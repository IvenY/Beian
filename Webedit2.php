...
<body>
	...
	<div class="dx_cells weui_cells_form">
		...
		<div class="weui_cell">
			...
			<div class="weui_cell_bd weui_cell_primary">
				<textarea class="weui_textarea" name="ym"placeholder="每行填写一个域名信息，回车换行。域名不能加www.,如果只有ip,则半角状态下填写ip地址"rows="3" disabled="disabled"><?php echo $row["ym"]?></textarea>
			</div>
		</div>
		<div class="demo">
			<div class="weui_cell_hd">
		...
		<div class="weui_cell">
			<div class="weui_cell_hd">
				<label class="dx_label">网站IP地址</label>
			</div>
			<div class="weui_cell_bd weui_cell_primary">
