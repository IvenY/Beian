			...
			<div class="weui_cell_hd">
				<label <?php if ($row['czzt']<=100){
					echo "style='color:red'";}else{
				 	echo "style='color:#073F89'";}?>>第一步、 <span style="color: black;">修改主体信息</span>
				</label>
			</div>
			<div class="dx_tag">
				...
				<a class="tag bg-yellow" href="javascript:void(0)" onclick="cancel(<?php echo $row['czzt']?>,'addWz')">撤销变更</a>
			</div>
		</div>
		<div class="weui_cell" >
			<div class="weui_cell_hd">
