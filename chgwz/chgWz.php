...
<body>
	<div class="weui_cells_title">变更网站需要进行如下步骤</div>
	<div class="dx_cells weui_cells_form">
		<div class="weui_cell">
			<div class="weui_cell_hd">
				<label <?php if ($row['czzt']<=100){
					echo "style='color:red'";}else{
				 	echo "style='color:#073F89'";}?>>第一步、 <span style="color: black;">修改网站信息</span>
				</label>
			</div>
			<div class="dx_tag">
				...
				<a class="tag bg-yellow" href="javascript:void(0)" onclick="cancel(<?php echo $row['czzt']?>,'chgWz')">撤销变更</a>
			</div>
		</div>
		<div class="weui_cell" >
			<div class="weui_cell_hd">
		...
		<div class="dx_tag" <?php if ($row['czzt']<101) echo "style='display: none'";?>>
				<a class="tag bg-blue" href="../cert.php?mkdm=<?php echo $mkdm?>">开始上传</a> 
		...
		<div class="weui_cell">
			...
			<div class="dx_tag" <?php if ($row['czzt']<102) echo "style='display: none'";?>>
				<a class="tag bg-yellow" href="../reject.php?mkdm=<?php echo $mkdm?>">查看退回信息</a>
			</div>
		</div>
		<div class="weui_cell">
			<div class="weui_cell_hd">
			...
			<div class="dx_tag" <?php if ($row['czzt']<110) echo "style='display: none'";?>>
				<a class="tag bg-blue" href="../applyCurtain.php?mkdm=<?php echo $mkdm?>">申请幕布</a> 
				<a class="tag bg-blue" href="../curtainPhoto.php?mkdm=<?php echo $mkdm?>">上传照片</a> 
				<a class="tag bg-blue" href="javascript:void(0)" onclick="submitInfo(<?php 
